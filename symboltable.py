...
f.write(("\nName\tSize\tTotal\tSymLAb\tDefUdf\tAddr\tLitEntry")+os.linesep)
if __name__=="__main__":
	...
	line=fp.readlines()
		...
		if 'resb' in str1:
			...
			if(str(st) in lit):
				f.write(("%s\t%d\t%d\t%s\t%c\t%s\tLIT%s"%(str1[0],resbsize,cnt,symbol,symdef,addr,str(st-2)))+os.linesep)
			else:
				f.write(("%s\t%d\t%d\t%s\t%c\t%s\tLIT%s"%(str1[0],resbsize,cnt,symbol,symdef,addr,str(st-2)))+os.linesep)
		...
		if 'resd' in str1:
			...
			if(str(st) in lit):
				f.write(("%s\t%d\t%d\t%s\t%c\t%s\tLIT%s"%(str1[0],resdsize,cnt,symbol,symdef,addr,str(st-2)))+os.linesep)
			else:
				f.write(("%s\t%d\t%d\t%s\t%c\t%s\tLIT%s"%(str1[0],resdsize,cnt,symbol,symdef,addr,str(st-2)))+os.linesep)
		if 'resw' in str1:
			reswsize=2
			...
			if(str(st) in lit):
				f.write(("%s\t%d\t%d\t%s\t%c\t%s\tLIT%s"%(str1[0],reswsize,cnt,symbol,symdef,addr,str(st-2)))+os.linesep)
			else:
				f.write(("%s\t%d\t%d\t%s\t%c\t%s\tLIT%s"%(str1[0],reswsize,cnt,symbol,symdef,addr,str(st-2)))+os.linesep)
		if 'resq' in str1:
			resqsize=8
			...
			if(str(st) in lit):
				f.write(("%s\t%d\t%d\t%s\t%c\t%s\tLIT%s"%(str1[0],resqsize,cnt,symbol,symdef,addr,str(st-2)))+os.linesep)
			else:
				f.write(("%s\t%d\t%d\t%s\t%c\t%s\tLIT%s"%(str1[0],resqsize,cnt,symbol,symdef,addr,str(st-2)))+os.linesep)
